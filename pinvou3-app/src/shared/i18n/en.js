...
const conversationEn = {
  completed:'Completed', failed:'Failed', interrupted:'Interrupted', limitReached:'Limit reached', processing:'Processing', processingActive:'Processing', processed:'Processed', processDetails:'Thinking process', working:'Working', worked:duration=>duration?`Worked for ${duration}`:'Work details',
  toolBatch:count=>`${count} tool operations`, toolBatchRunning:count=>`${count} running`,
...
const codexEn = {
  ...
  activeHint:'Tool calls, reasoning, plans, and permission requests are shown with their original ACP semantics, separate from Lingo work-session messages.',
  nativeActiveHint:'Tool calls, reasoning, and confirmations are shown with Lingo Engine semantics, on the same engine lane as work sessions.',
  ...
  nativeDraftHint:'Start typing to create a temporary session, or choose a project directory from the lower-left corner so Lingo works directly in it.',
  ...
  temporarySessionDesc:'Use an isolated directory managed by Lingo', recentProjects:'Recent projects',
  ...
  compactStart:'Compacting context', compactDone:'Context compacted', compactFail:'Context compaction failed', compactAuto:'Automatic',
  nativeCompactInactive:'The session engine is not running yet. Send a message before compacting the context',
  nativeUsageTitle:(used,pct)=>`Context used: ${used}${pct == null ? '' : ` (${pct}%)`}. It compacts automatically near the limit; click to compact early`,
  ...
  bridgeRepair:'Repair or reinstall Lingo. In development, run npm run prepare:codex-bridge.',
  ...
  finishAgentAuth:agent=>`Complete ${agent} authorization in the browser; Lingo will connect automatically`,
  ...
  finishBrowserAuth:'Complete ChatGPT authorization in the browser; Lingo will connect automatically',
...
const acpProvidersEn = {
  ...
  thirdPartyWarning:'Lingo never uploads your API Key.',
...
export const dictEn = {
  ...browserEn,
        ...
        remoteKbPromoteOwner: 'Make owner', remoteKbDemoteOwner: 'Remove owner', remoteKbPromoteOwnerConfirm: 'Make “{name}” an owner? They can manage sharing and members.', remoteKbDemoteOwnerConfirm: 'Remove owner access from “{name}”?', remoteKbModelTitle: 'Semantic search model', remoteKbModelReady: 'Available', remoteKbModelMissing: 'Not downloaded', remoteKbModelDownloading: 'Downloading; this continues after Lingo closes', remoteKbDownloadModel: 'Download', remoteKbModelDownloadingAction: 'Downloading', remoteKbPermanentDelete: 'Delete permanently', remoteKbPermanentDeleteConfirm: 'Permanently delete “{name}”? This cannot be undone.',
        ...
        kbOutSub: 'Everything you and Lingo have made, all in one place.',
        ...
        kbOutEmpty: 'No outputs yet', kbOutEmptyHint: 'Chat with Lingo — things you make together will appear here.',
        ...
        kbModelPkgName: 'Lingo Embedding Model', kbModelPkgSub: 'Multilingual vector model · int8 quantized · CPU-only, fully local',
        ...
        uiChatExtra: { transferRevision:type=>`Lingo · ${type} · Revision handoff`, draftingScheduled:'⏰ Preparing scheduled task draft…' },
        ...
        communityQrAlt: 'Lingo QQ group QR code', communityQrPlaceholder: 'QR placeholder', communityChannelTag: 'Chinese QQ community',
        ...
        chatGreeting: 'Hi — what would you like to work on today?', artifacts: 'Artifacts', placeholder: 'What can I help you with today?', disclaimer: 'Lingo may display inaccurate info, so double-check.', ctxUsage: 'Context',
        ctxUsageTooltip: (percent, used, total) => `${percent}% · ${used} / ${total} context used; compacts automatically near the limit`,
        ...
        cpExpertJoined: 'Joined the conversation',
        cpExpertRemoved: 'Removed',
        ...
        uiComposerSuggestions: {
          hint: '@ reference conversation files, / choose a skill', files: 'Conversation files', skillsAndCommands: 'Choose a skill', codeSkills: 'Skills available in Code', codeScopeHint: 'Only skills enabled for Code are shown',
          loading: 'Loading…', loadFailed: 'Could not load suggestions. Please retry.', noFiles: 'No matching conversation files. Use + to add a file.', noMatches: 'No matching enabled skills', noCodeSkills: 'No matching skills are available in Code. Use “Manage Code skills” in Capability Center to enable them.',
          keyboardHint: '↑ ↓ select · Enter insert · Esc close', manageSkills: 'Manage skills', manageCodeSkills: 'Manage Code skills', retry: 'Retry',
          skillCode: code => `Skill ID /${code}`,
          file: 'File', skill: 'Skill', codeAvailable: 'Available in Code', command: 'Command',
        },
        composerTools: 'Tools', composerConnectors: 'Connectors', composerSkills: 'Skills', composerModelLabel: name => `Model: ${name}`, composerConnectedServices: 'Connected services', composerConnected: 'Connected', composerInstalledTools: 'Connected tools', composerInstalledSkills: 'Skills', composerNoTools: 'No tools installed', composerNoConnectors: 'No connectors connected', composerToolOn: 'On', composerManageTools: 'Manage tools', composerAddConnectors: 'Add connectors', composerAddSkills: 'Add skills',
        ...
        // Lingo review card. 品/悟 glyphs are brand marks, kept; surrounding text follows language.
        pvLoadingPin: 'Lingo 品 · Review', pvLoadingWu: 'Lingo 悟 · Explore',
        ...
        uiqTitle: 'Lingo needs your input',
...
dictEn.uiPlatformMisc = {
  htmlLang: 'en',
  appTitle: BRAND_NAME,
  petTitle: 'Lingo Desktop Companion',
  hostFilePicker: {
...
dictEn.uiSettingsView = {
  ...
  memorySummary: total => `Lingo remembers your preferences, work context, and recent activities so follow-up conversations pick up the context more easily. ${total} active memories recorded.`,
  memoryOffDesc: 'Once enabled, Lingo can remember how to address you, your stable preferences, work context, and recent activities, so you repeat yourself less.',
  ...
  memoryOffNotice: 'Once memory is enabled, Lingo uses this information in conversations and automatically organizes new long-term and recent memories.',
  ...
  memoryRecentHint: 'Recent memories record what is in progress or just finished, helping Lingo pick up the context. They fade automatically over time, and you can archive or delete them manually.',
...
desktopHint:'Install Obsidian on the desktop and create a vault first, then check again here.',
  ...
  codeAvailableOnly:'Available in Code', codeAvailableOnlyHint:'Show only skills that Code conversations can currently use', codeAvailable:'Available in Code', codeUnavailable:'Not enabled in Code', manageCodeSkills:'Manage Code skills', manageCodeSkillsHint:'Choose which skills Code conversations can use',
  codeAvailabilityLoading:'Loading Code status…', codeAvailabilityUnknown:'Code status unavailable', codeAvailabilityLoadFailed:'Could not load Code skill status. Please retry.',
  emptyNoCodeAvailable:'No skills are available in Code', emptyNoCodeAvailableHint:'Turn off this filter, then choose “Manage Code skills” to enable the skills you need.',
...
Object.assign(dictEn.uiToolStore, {
  ...
  recycleBin:'Recycle Bin', recycleBinTitle:'Capability Recycle Bin', recycleBinEmpty:'Recycle bin is empty', recycleBinEmptyHint:'Uploaded connector or skill packages you delete are moved here; you can restore or permanently delete them.',
  ...
  connectorMore:name=>`More actions for ${name}`, connectorDetails:'View details', connectorManage:'Manage', connectorDisconnect:'Disconnect', connectorNothingToDelete:'Not added to this device. Nothing to delete.', connectorAdded:'Added', connectorNeedsAuth:'Authorization needed', connectorNeedsConnection:'Not connected', connectorAvailable:'Not added',
  removeConnector:'Delete', removeConnectorTitle:name=>`Delete ${name} from this app?`, removeConnectorHint:'Remove the local connection, sign-in information and companion capabilities. Add or connect it again to use it. Your third-party account and cloud files are preserved; uploaded packages move to the recycle bin.', connectorRemoved:name=>`${name} removed from this app`, connectorRemovedCleanupWarning:'Local content was removed. Third-party sign-out did not finish, but it does not block removal from the app.', connectorRemoveFailed:'Removal did not complete. Connection status has been refreshed; please try again.',
  skillMore:name=>`More actions for ${name}`, removeSkill:'Delete', skillNothingToDelete:'Not installed on this device. Nothing to delete.', builtinSkillCannotDelete:'Built-in skills cannot be deleted. You can turn them off in Manage Code Skills.', removeSkillTitle:name=>`Delete the ${name} skill from this app?`, removeSkillHint:'The skill stops applying to new turns in Work, Design, and Code conversations. Message history is preserved. Uploaded skill packages move to the recycle bin, where they can be permanently deleted.', removeCompanionSkillHint:'This skill is supplied by a connector package. Deleting it also removes that connector and its companion capabilities. It stops applying to new turns in every conversation; message history is preserved.', skillRemoved:name=>`The ${name} skill was removed from this app`, skillRemovedWithConnector:'Its connector and companion capabilities were removed too.', skillRemoveFailed:'Skill removal did not complete. Capability status has been refreshed; please try again.',

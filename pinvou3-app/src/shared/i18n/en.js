...
const codexEn = {
  ...
  activeHint:'Tool calls, reasoning, plans, and permission requests are shown with their original ACP semantics, separate from 智灵 work-session messages.',
  nativeActiveHint:'Tool calls, reasoning, and confirmations are shown with 智灵 Engine semantics, on the same engine lane as work sessions.',
  ...
  nativeDraftHint:'Start typing to create a temporary session, or choose a project directory from the lower-left corner so 智灵 works directly in it.',
  ...
  temporarySessionDesc:'Use an isolated directory managed by 智灵', recentProjects:'Recent projects',
  ...
  bridgeRepair:'Repair or reinstall 智灵. In development, run npm run prepare:codex-bridge.',
  ...
  finishAgentAuth:agent=>`Complete ${agent} authorization in the browser; 智灵 will connect automatically`,
  ...
  finishBrowserAuth:'Complete ChatGPT authorization in the browser; 智灵 will connect automatically',
...
const acpProvidersEn = {
  ...
  thirdPartyWarning:'智灵 never uploads your API Key.',
...
export const dictEn = {
  ...browserEn,
        ...
        remoteKbPromoteOwner: 'Make owner', remoteKbDemoteOwner: 'Remove owner', remoteKbPromoteOwnerConfirm: 'Make “{name}” an owner? They can manage sharing and members.', remoteKbDemoteOwnerConfirm: 'Remove owner access from “{name}”?', remoteKbModelTitle: 'Semantic search model', remoteKbModelReady: 'Available', remoteKbModelMissing: 'Not downloaded', remoteKbModelDownloading: 'Downloading; this continues after 智灵 closes', remoteKbDownloadModel: 'Download', remoteKbModelDownloadingAction: 'Downloading', remoteKbPermanentDelete: 'Delete permanently', remoteKbPermanentDeleteConfirm: 'Permanently delete “{name}”? This cannot be undone.',
        ...
        kbOutSub: 'Everything you and 智灵 have made, all in one place.',
        ...
        kbOutEmpty: 'No outputs yet', kbOutEmptyHint: 'Chat with 智灵 — things you make together will appear here.',
        ...
        kbModelPkgName: '智灵 Embedding Model', kbModelPkgSub: 'Multilingual vector model · int8 quantized · CPU-only, fully local',
        ...
        uiChatExtra: { transferRevision:type=>`智灵 · ${type} · Revision handoff`, draftingScheduled:'⏰ Preparing scheduled task draft…' },
        ...
        communityQrAlt: '智灵 QQ group QR code', communityQrPlaceholder: 'QR placeholder', communityChannelTag: 'Chinese QQ community',
        ...
        chatGreeting: 'Hi — what would you like to work on today?', artifacts: 'Artifacts', placeholder: 'What can I help you with today?', disclaimer: '智灵 may display inaccurate info, so double-check.', ctxUsage: 'Context',
        ...
        // 智灵 review card. 品/悟 glyphs are brand marks, kept; surrounding text follows language.
        pvLoadingPin: '智灵 品 · Review', pvLoadingWu: '智灵 悟 · Explore',
...
dictEn.uiSettingsView = {
  ...
  memorySummary: total => `智灵 remembers your preferences, work context, and recent activities so follow-up conversations pick up the context more easily. ${total} active memories recorded.`,
  memoryOffDesc: 'Once enabled, 智灵 can remember how to address you, your stable preferences, work context, and recent activities, so you repeat yourself less.',
  ...
  memoryOffNotice: 'Once memory is enabled, 智灵 uses this information in conversations and automatically organizes new long-term and recent memories.',
  ...
  memoryRecentHint: 'Recent memories record what is in progress or just finished, helping 智灵 pick up the context. They fade automatically over time, and you can archive or delete them manually.',

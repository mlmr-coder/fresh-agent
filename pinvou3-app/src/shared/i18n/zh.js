...
const codexZh = {
  ...
  activeHint:'工具调用、思考、计划和权限请求会按 ACP 原始语义展示，不进入智灵原有工作会话消息框架。',
  nativeActiveHint:'工具调用、思考和选择确认按智灵 Engine 语义展示，与工作会话共用同一引擎链路。',
  draftHint:'直接输入即可创建临时会话，也可以从输入框左下角选择项目目录。',
  nativeDraftHint:'直接输入即可创建临时会话，也可以从输入框左下角选择项目目录让智灵直接在其中工作。',
  ...
  temporarySessionDesc:'使用 智灵 管理的隔离目录', recentProjects:'最近项目',
  ...
  bridgeRepair:'请修复或重新安装 智灵。开发环境可运行 npm run prepare:codex-bridge。',
  ...
  finishAgentAuth:agent=>`请在浏览器中完成 ${agent} 授权；完成后 智灵 会自动连接`,
  ...
  finishBrowserAuth:'请在浏览器中完成 ChatGPT 授权；完成后 智灵 会自动连接',
...
const acpProvidersZh = {
  ...
  thirdPartyWarning:'智灵 不会将您的 API Key 上传。',
...
export const dictZh = {
  ...browserZh,
        ...
        remoteKbPromoteOwner: '设为所有者', remoteKbDemoteOwner: '取消所有者', remoteKbPromoteOwnerConfirm: '将“{name}”设为所有者？该成员将可以管理共享与成员。', remoteKbDemoteOwnerConfirm: '取消“{name}”的所有者权限？', remoteKbModelTitle: '语义检索模型', remoteKbModelReady: '已可用', remoteKbModelMissing: '尚未下载', remoteKbModelDownloading: '正在下载，关闭 智灵 后仍会继续', remoteKbDownloadModel: '下载', remoteKbModelDownloadingAction: '下载中', remoteKbPermanentDelete: '永久删除', remoteKbPermanentDeleteConfirm: '永久删除“{name}”？此操作无法撤销。',
        remoteKbOtherNetwork: '其他网络地址（可选）', remoteKbOtherNetworkPlaceholder: '例如 100.64.12.34:3210 或 cube.ts.net:3210',
        remoteKbCreateHost: '创建共享知识库', remoteKbHostCreated: '共享知识库已创建', remoteKbReconnectHost: '重新连接本机服务', remoteKbHostReconnected: '已恢复本机管理连接', remoteKbUpgradeHost: '升级服务', remoteKbHostUpgraded: '共享知识库服务已升级', remoteKbClientOutdatedTitle: '请先升级 智灵', remoteKbClientOutdatedDesc: '当前 智灵 {appVersion} 低于本机服务 {serviceVersion}。为保护数据，不会降级服务。', remoteKbHostProgressCreateTitle: '正在创建共享知识库', remoteKbHostProgressReconnectTitle: '正在恢复本机连接', remoteKbHostProgressUpgradeTitle: '正在升级共享知识库', remoteKbHostProgressPrepare: '正在准备安装资源', remoteKbHostProgressInstall: '等待系统授权并安装服务', remoteKbHostProgressConnect: '正在连接本机服务', remoteKbHostProgressComplete: '已完成', remoteKbHostProgressFailed: '操作未完成', remoteKbHostProgressHint: '如系统弹出授权窗口，请完成授权。此过程通常需要几十秒。', remoteKbHostProgressRetry: '重试', remoteKbNoLanEndpoint: '未找到可供团队访问的局域网地址，请连接局域网后重试', remoteKbHostSettings: '主机设置', remoteKbHostSettingsDesc: '备份、恢复或管理本机托管服务。', remoteKbDangerZone: '停用与删除', remoteKbDangerZoneDesc: '停止托管会保留现有数据；删除服务和数据后无法恢复。', remoteKbBackupFileType: '智灵备份', remoteKbBackup: '创建备份', remoteKbRestoreBackup: '恢复备份', remoteKbRecoveryTitle: '保存恢复码', remoteKbRecoveryDesc: '备份已加密。本机恢复无需恢复码；换一台主机时需要此恢复码。请与备份文件分开保存。', remoteKbCopyRecovery: '复制恢复码', remoteKbRestoreTitle: '恢复共享知识库', remoteKbRestoreDesc: '留空恢复码表示恢复到当前主机；输入恢复码表示迁移到这台主机。', remoteKbRecoveryPlaceholder: '换机迁移时粘贴恢复码（本机恢复请留空）', remoteKbSameHostMode: '本机恢复会保留当前服务身份和成员，仅恢复知识内容。', remoteKbMigrationMode: '换机迁移只导入知识内容，并创建新的服务身份；原成员需要重新加入。', remoteKbRestoreAction: '开始恢复', remoteKbRestoreConfirm: '恢复当前主机的知识内容？当前内容会被备份中的内容替换，服务身份和成员保持不变。', remoteKbMigrateConfirm: '将备份迁移到这台主机？当前内容会被替换，并创建新的服务身份和所有者。', remoteKbRestored: '共享知识库已恢复', remoteKbMigrated: '共享知识库内容已迁移到当前主机', remoteKbRemoveHost: '停止托管', remoteKbDeleteHost: '删除服务和数据', remoteKbRemoveHostConfirm: '停止本机的共享知识库服务？已有数据会保留，之后可以重新启用。', remoteKbDeleteHostConfirm: '永久删除本机的共享知识库服务和全部数据？此操作无法撤销。', remoteKbHostRemoved: '共享知识库服务已停止，数据已保留', remoteKbHostDeleted: '共享知识库服务和数据已删除',
        outputs: '产出物',
        ...
        kbOutEmpty: '还没有产出物', kbOutEmptyHint: '和 智灵 聊聊，一起做出来的东西会出现在这里。',
        ...
        kbModelPkgName: '智灵 Embedding 模型', kbModelPkgSub: '多语言语义向量模型 · int8 量化 · 纯 CPU 本地运行',
        ...
        uiChatExtra: { transferRevision:type=>`智灵 · ${type} · 转交修订`, draftingScheduled:'⏰ 正在整理定时任务草稿…' },
        ...
        communityQrAlt: '智灵 QQ 群二维码', communityQrPlaceholder: '二维码占位', communityChannelTag: '中文 QQ 社区',
        ...
        chatGreeting: '你好，今天想聊点什么？', artifacts: '产物与代码', placeholder: '今天帮你做些什么？', disclaimer: '智灵 可能会生成不准确的信息，请仔细核实。', ctxUsage: '上下文',
        ...
        // 智灵检阅卡(PinvouSummonCard/Rows/Loading)。品/悟 字形是品牌、保留;周边文案随语言。
        pvLoadingPin: '智灵 品·查错检阅', pvLoadingWu: '智灵 悟·发散补全',
...
dictZh.uiSettingsView = {
  ...
  memorySummary: total => `智灵 会记住你的偏好、工作背景和近期事项，让后续对话更容易接上上下文。已记录 ${total} 条有效记忆。`,
  memoryOffDesc: '开启后，智灵 可以记住你的称呼、稳定偏好、工作背景和近期事项，减少重复说明。',
  memoryTurnOff: '关闭记忆',
  memoryTurnOn: '开启记忆',
  ...
  memoryOffNotice: '开启记忆后，智灵 会在对话中使用这些信息，并自动整理新的长期记忆与近期记忆。',
  ...
  memoryRecentHint: '近期记忆会记录最近正在推进和刚完成的事情，用来帮助 智灵 接上上下文。它会随时间自动淡出，你也可以手动归档或删除。',
...
visualizer: { title:'数据分析可视化', subtitle:'Chart.js 仪表盘 / 图表分析 / HTML 可视化', desc:'将结构化数据、表格汇总和业务指标转成符合 智灵 宿主体验的 HTML 可视化仪表盘。默认使用 Chart.js、无障碍 canvas、自定义图例、扁平配色，并通过 .html 产物卡交付。', latency:'本地' },
'package-author': { title:'插件包标准化', subtitle:'把技能/MCP/函数整理成可上传的标准插件包', desc:'把散乱的技能（SKILL.md）、MCP 服务或它们的组合整理成 智灵 商店可导入的标准插件包：补 plugin.json、补 mcp/manifest.json、补 SKILL.md frontmatter、生成图标、校验命名与布局，最后产出目录或 zip。', latency:'本地' },

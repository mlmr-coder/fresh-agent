...
用法:
    python3 scripts/report_inbox_today.py
    python3 scripts/report_inbox_today.py --days 3     # 最近 3 天
    python3 scripts/report_inbox_today.py --detail     # 额外拉取每条正文 (entry get)
    python3 scripts/report_inbox_today.py --dry-run
"""

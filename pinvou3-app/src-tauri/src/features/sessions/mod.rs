...
pub struct SessionStore {
    ...
    /// 智灵原生 code 会话判定（ACP 会话恒为 plain，见 codex_acp store）。
...
/// 原生代码会话(智灵 Engine)的执行根解析器:绑定了项目目录的原生代码会话

...
APP_BIN="$APP_DIR/src-tauri/target/universal-apple-darwin/release/bundle/macos/智灵.app/Contents/MacOS/pinvou3-tauri"
if [ ! -f "$APP_BIN" ]; then
...
SOURCE="$APP_DIR/src-tauri/target/universal-apple-darwin/release/bundle/dmg/智灵_${VERSION}_universal.dmg"

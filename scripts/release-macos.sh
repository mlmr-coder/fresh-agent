...
APP_BIN="$APP_DIR/src-tauri/target/universal-apple-darwin/release/bundle/macos/Lingo.app/Contents/MacOS/pinvou3-tauri"
if [ ! -f "$APP_BIN" ]; then
...
SOURCE="$APP_DIR/src-tauri/target/universal-apple-darwin/release/bundle/dmg/Lingo_${VERSION}_universal.dmg"
